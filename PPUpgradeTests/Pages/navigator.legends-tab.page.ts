...
/**
 * Navigator Legends Tab Page Object Model
 * Handles expand/collapse functionality for the Legends static tab
 */
export class NavigatorLegendsTab {
    private page: Page;
    ...
    async verifyTabContentLoaded() {
        ...
        if (hasTable || hasContent) {
            console.log('✓ Legends tab content loaded successfully');
        } else {
            console.log('⚠ Legends tab content may not be fully loaded');
        }
    }
}
