...
/**
 * Navigator Status Tab Page Object Model
 * Handles expand/collapse functionality for the Status static tab
 */
export class NavigatorStatusTab {
    private page: Page;
    ...
    async verifyTabContentLoaded() {
        ...
        if (hasTable || hasContent) {
            console.log('✓ Status tab content loaded successfully');
        } else {
            console.log('⚠ Status tab content may not be fully loaded');
        }
    }
}
